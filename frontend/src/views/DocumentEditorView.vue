...
<style scoped>
.doc-editor-page { flex:1; display:flex; flex-direction:column; background:var(--panel-bg); color:var(--text-primary); height:100%; overflow:hidden; }
.ed-topbar { display:flex; align-items:center; gap:10px; padding:10px 20px; background:var(--panel-header-bg); border-bottom:1px solid var(--border-color); flex-shrink:0; flex-wrap:wrap; }
.back-btn { display:flex; align-items:center; gap:6px; background:transparent; border:1px solid var(--text-muted); color:var(--text-primary); padding:8px 14px; border-radius:8px; cursor:pointer; }
.back-btn:hover { background:var(--sidebar-active); }
.ed-title { margin:0; font-size:16px; font-weight:600; }
.ed-docnum { color:var(--text-secondary); font-weight:400; font-size:14px; }
.spacer { flex:1; }
.action-btn { padding:8px 16px; border-radius:8px; border:1px solid var(--text-muted); background:var(--sidebar-active); color:var(--text-primary); cursor:pointer; font-size:13px; min-height:36px; }
.action-btn:hover { background:var(--text-muted); }
...
.ed-left { width:50%; border-right:1px solid var(--border-color); display:flex; flex-direction:column; min-width:360px; }
.ed-right { flex:1; display:flex; flex-direction:column; background:var(--chat-bg); min-width:360px; }
.ed-scroll { flex:1; overflow-y:auto; padding:16px 20px 80px; }

.ed-sec { background:var(--panel-header-bg); border:1px solid var(--border-color); border-radius:10px; padding:16px; margin-bottom:14px; }
...
.fg label { color:var(--text-secondary); font-size:12px; }
.fg-full { grid-column:1/-1; }
:deep(.el-input__wrapper), :deep(.el-textarea__inner) { background:var(--sidebar-active) !important; box-shadow:none !important; }
:deep(.el-input__inner), :deep(.el-textarea__inner), :deep(.el-select__placeholder) { color:var(--text-primary) !important; }
:deep(.el-input-number .el-input__wrapper) { background:var(--sidebar-active); }

.type-cards { display:flex; gap:10px; }
.type-card { flex:1; background:var(--sidebar-active); border:2px solid transparent; border-radius:10px; padding:14px; cursor:pointer; text-align:center; transition:all .15s; }
.type-card:hover { background:var(--text-muted); }
...
.seller-preview { background:var(--panel-bg); border-radius:8px; padding:12px; font-size:13px; line-height:1.8; }
.sp-line { color:var(--text-primary); }

.items-table-wrap { overflow-x:auto; }
.items-table { width:100%; border-collapse:collapse; font-size:12px; }
.items-table th { background:var(--panel-bg); color:var(--text-secondary); font-weight:500; text-align:left; padding:8px 6px; border-bottom:1px solid var(--text-muted); font-size:11px; }
.items-table td { padding:4px; border-bottom:1px solid var(--border-color); vertical-align:middle; }
.items-table :deep(.el-input__wrapper) { padding:0 8px; }
.idx-cell { text-align:center; color:var(--text-secondary); }
...
.total-label { text-align:right; font-weight:600; padding:8px !important; color:var(--text-primary); }
.total-amount { text-align:right; font-weight:700; color:#f59e0b; font-size:14px; padding:8px !important; }
.add-item-btn { margin-top:8px; background:transparent; border:1px dashed var(--text-muted); color:var(--text-secondary); padding:8px; width:100%; border-radius:8px; cursor:pointer; }
.add-item-btn:hover { background:var(--sidebar-active); color:var(--text-primary); }
.amount-words { margin-top:10px; padding:10px; background:var(--panel-bg); border-radius:8px; font-size:12px; }
.aw-label { color:var(--text-secondary); }
.aw-val { color:var(--text-primary); font-weight:500; }

.ed-bottom-actions { display:flex; gap:8px; padding:12px 0; justify-content:flex-end; flex-wrap:wrap; }

/* Preview area */
.preview-toolbar { padding:8px 16px; display:flex; gap:8px; align-items:center; background:var(--panel-header-bg); border-bottom:1px solid var(--border-color); flex-shrink:0; }
.mini-btn { background:var(--sidebar-active); border:1px solid var(--text-muted); color:var(--text-primary); padding:5px 12px; border-radius:6px; cursor:pointer; font-size:12px; }
.mini-btn:hover { background:var(--text-muted); }
