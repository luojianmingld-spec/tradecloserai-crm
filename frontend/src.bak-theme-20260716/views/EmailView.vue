    ...
    <div class="email-content">
      ...
      <div class="account-panel">
        <div v-if="accounts.length === 0" class="empty-state">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#8696a0" stroke-width="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          <p>还没有添加邮箱</p>
...
.page-header {
  ...
  padding: 12px 20px;
  background: var(--sidebar-header-bg, #202c33);
...
.account-panel {
  width: 260px;
  min-width: 260px;
  border-right: 1px solid var(--border-color, #2a3942);
  overflow-y: auto;
}
...
.account-item:hover {
  background: var(--sidebar-hover, #202c33);
}
...
.account-status.connected { background: #00a884; color: white; }
.account-status.disconnected { background: #6b7280; color: white; }
.account-status.error { background: #ef4444; color: white; }
...
.btn-secondary:hover { background: var(--sidebar-hover, #202c33); }
...
.btn-icon:hover { background: var(--sidebar-hover, #2a3942); }
...
.toast.success { background: #00a884; color: white; }
