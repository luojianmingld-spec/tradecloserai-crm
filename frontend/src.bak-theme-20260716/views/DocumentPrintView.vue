...
.print-toolbar { position:sticky; top:0; background:#202c33; color:#e9edef; padding:10px 20px; display:flex; align-items:center; gap:10px; z-index:10; }
.p-btn { padding:8px 18px; border-radius:8px; border:1px solid #3b4a54; background:#2a3942; color:#e9edef; cursor:pointer; }
.p-btn.primary { background:#00a884; border-color:#00a884; color:#fff; }
