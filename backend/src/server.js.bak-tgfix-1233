      ...
      try {
        ...
        if (io) {
          ...
          io.emit("whatsapp:message_sent", {
            jid: toJid,
            message: { id: savedWa.id, body: textMsg, fromMe: true, timestamp: savedWa.timestamp, platform: "telegram", jid: toJid, translation: translationObj, waMessageId: savedWa.waMessageId },
          });
